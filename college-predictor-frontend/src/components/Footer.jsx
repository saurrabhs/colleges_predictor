      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              <a 
                href="https://www.linkedin.com/company/collegepredictor" 
                target="_blank" 
              ...
              <a 
                href="https://www.instagram.com/collegepredictor" 
                target="_blank" 
                rel="noopener noreferrer" 
              ...
              <a 
                href="https://www.youtube.com/@collegepredictor" 
                target="_blank" 
                rel="noopener noreferrer" 
        ...
        <div className="mt-12 border-t border-gray-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-base text-gray-400">&copy; 2025 CollegePredictor. All rights reserved.</p>
